    ...
    <main className="min-h-screen bg-slate-950 text-slate-50 flex flex-col items-center py-10 px-4">
      <div className="w-full max-w-xl">
        ...
        <p className="mb-4 text-slate-300">
          This page is public. You can place an order without paying. We’ll send
          the order details automatically to
          <span className="font-semibold"> dextermo1025@beaufortschools.org</span>.
        </p>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-md bg-slate-950 border border-slate-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
              placeholder="e.g. personal website, logo design, etc."
            />
          </div>
          ...
          {status === "success" && (
            <p className="text-sm text-emerald-400">
              Your order was submitted! We’ll email the details to the seller.
            </p>
          )}
